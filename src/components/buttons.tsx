export const Download04Icon = ({ show = true }: { show?: boolean }) => {
  if (!show) {
    return null;
  }
  return (
...
export const Share01Icon = ({ show = true }: { show?: boolean }) => {
  if (!show) {
    return null;
  }
  return (
...
export const QrCodeIcon = ({ show = true }: { show?: boolean }) => {
  if (!show) {
    return null;
  }
  return (
...
export const Copy01Icon = ({ show = true }: { show?: boolean }) => {
  if (!show) {
    return null;
  }
  return (
...
export const Tick01Icon = ({ show = true }: { show?: boolean }) => {
  if (!show) {
    return null;
  }
  return (
